...
<?php
    $cod_artigo = isset($_GET['artigo'])?$_GET['artigo']:0;
    $aprincipal = new Artigos();
    $adestaque = new Artigos();
    $destaques = $adestaque->getArtigosDestaques();
    $principal = $aprincipal->getArtigo($cod_artigo);
?>
    ...
    <div class="container">
        <div class="row">
            ...
            <section class="col-sm-7 col-xs-pull-0 col-lg-pull-3 col-lg-offset-1">
                 <?php foreach ($principal as $pastoral)
                 {
                 ?>
                <h3 class="uppercase"><?php echo $pastoral["titulo"]; ?></h3>
                <article class="col-md-12">
                    <?php echo $pastoral["conteudo"]; ?>
                </article>
                <?php } ?>
            </section>
        </div>
